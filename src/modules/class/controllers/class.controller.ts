...
import {
  ...
  AssignTeacherToClassResponseDto,
} from '../dto';
...
export class ClassController {
  ...
  ): Promise<AssignTeacherToClassResponseDto> {
  ...
  // --- PATCH: REACTIVATE CLASS (ADMIN ONLY) ---
  @Patch(':id/reactivate')
  @Roles(UserRole.ADMIN)
  @DocsReactivateClass()
  async reactivateClass(@Param('id', ParseUUIDPipe) classId: string) {
    return this.classService.reactivateClass(classId);
  }
}
